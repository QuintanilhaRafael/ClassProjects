...
function testaAs() {                                //Para garantir que um dos jogadores não comece com duas cartas Ás.
...
function vezDoUsuario() {                             //Laço do usuário: Momento que o usuário continua comprando as cartas até que decida parar ou passe de 21 pontos.
   while (resposta === true) {
      confirmacao()
      if (resposta === true) {
         compraUsuario()
